...
export function Sidebar() {
    ...
    return (
        ...
        <aside className="w-64 bg-surface p-6 border-r border-border hidden md:block h-screen sticky top-0 shadow-sm z-10">
            <h1 className="text-2xl font-bold text-primary mb-10 tracking-tight">
                School AI
            </h1>
            <nav className="space-y-4">
                <Link to="/">
                    <div className={`group flex items-center space-x-3 p-3 rounded-xl cursor-pointer transition-all duration-200 border border-transparent ${isActive('/') ? 'bg-highlight shadow-md border-border' : 'hover:bg-highlight/60 hover:shadow-sm'}`}>
                        <div className={`p-2 rounded-lg transition-colors ${isActive('/') ? 'bg-primary/10' : 'bg-background group-hover:bg-primary/5'}`}>
            ...
            <div className="absolute bottom-6 left-6 right-6 pt-6 border-t border-border">
                <div className="space-y-2">
                    <Link to="/profile" className="flex items-center space-x-3 p-3 rounded-xl cursor-pointer hover:bg-highlight/60 hover:shadow-sm transition-all duration-200">
                    ...
                    <Link to="/settings" className="flex items-center space-x-3 p-3 rounded-xl cursor-pointer hover:bg-highlight/60 hover:shadow-sm transition-all duration-200">
